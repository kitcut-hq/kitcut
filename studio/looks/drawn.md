...
1. Decide the idea: one clear point, told in the film's length -- a setup, one action and a
   payoff you can hold for the last second or so. A longer film strings a few such beats
   together -- two to four for 30-60 s, four to eight for 90-120 s -- in places or moments
   that still build towards one point.
...
4. Call `stills` with about six times spread over the film -- ten or twelve for a film over
   a minute -- (always 0, and one just before the end), and Read `outputs/review/sheet.png`. Look hard: blank or near-empty frame 0, things cut
